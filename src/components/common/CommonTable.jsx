...
export default function CommonTable({
  ...
  const headersByType = {
    ...
    tickets: [
      ...
      { header: "Contact ID", accessor: "contactId", sortable: true },
      { header: "Contact Name", accessor: "contactName", sortable: true },
    ...
    expenses: [
      ...
      { header: "Description", accessor: "description", sortable: true },
      { header: "Customer", accessor: "relatedCustomerName", sortable: true },
      { header: "Department", accessor: "departmentName", sortable: true },
      { header: "Owner", accessor: "ownerName", sortable: true },
      { header: "Status", accessor: "status", sortable: true },
      { header: "Created At", accessor: "createdAt", sortable: true },
